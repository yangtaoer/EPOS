...
public class CuisineDao {
	...
	public void saveCuisine(Cui cui){
		...
		try {
			conn = DBUtil.getConnection();
			String sql = "INSERT INTO YD_Tables VALUES(55,?,?,?,sysdate,?,?,?)";
			PreparedStatement ps = conn.prepareStatement(sql);
	...
	public List<Cui> find_MWGD(Integer startIndex,Integer endIndex){
		...
		try {
			...
			String sql = "SELECT * FROM ("
					+ "SELECT ROWNUM RN,T.* FROM ("
					+ "SELECT * FROM yd_tables where no like '1%' ORDER BY no) T) "
					+ "WHERE RN BETWEEN ? AND ?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setInt(1, startIndex);
	...
	public int findRow_mwgd(){
		...
		try {
			conn = DBUtil.getConnection();
			String sqlPage = "select count(*) from yd_tables where no like '1%'";
	...
	public List<Cui> find_YSJG(Integer startIndex,Integer endIndex){
		...
		try {
			...
			String sql = "SELECT * FROM ("
					+ "SELECT ROWNUM RN,T.* FROM ("
					+ "SELECT * FROM yd_tables where no like '7%' ORDER BY no) T) "
					+ "WHERE RN BETWEEN ? AND ?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setInt(1, startIndex);
			ps.setInt(2, endIndex);
	...
	public int findRow_ysjg(){
		...
		try {
			conn =DBUtil.getConnection();
			String sqlPage = "select count(*) from yd_tables where no like '7%'";
			PreparedStatement ps1 = conn.prepareStatement(sqlPage);
			ResultSet rs1 = ps1.executeQuery();
			if(rs1.next()){
				 rows = rs1.getInt(1);
	...
	public List<Cui> find_HXHY(Integer startIndex,Integer endIndex){
		...
		try {
			...
			String sql = "SELECT * FROM ("
					+ "SELECT ROWNUM RN,T.* FROM ("
					+ "SELECT * FROM yd_tables where no like '5%' ORDER BY no) T) "
					+ "WHERE RN BETWEEN ? AND ?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setInt(1, startIndex);
			ps.setInt(2, endIndex);
	...
	public int findRow_hxhy(){
		...
		try {
			conn = DBUtil.getConnection();
			String sqlPage = "select count(*) from yd_tables where no like '5%'";
			PreparedStatement ps1 = conn.prepareStatement(sqlPage);
			ResultSet rs1 = ps1.executeQuery();
	...
	public List<Cui> find_JDCP(Integer startIndex,Integer endIndex){
		...
		try {
			...
			String sql = "SELECT * FROM ("
					+ "SELECT ROWNUM RN,T.* FROM ("
					+ "SELECT * FROM yd_tables where no like '3%' ORDER BY no) T) "
					+ "WHERE RN BETWEEN ? AND ?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setInt(1,startIndex);
			ps.setInt(2, endIndex);
	...
	public int findRow_jdcp(){
		...
		try {
			conn = DBUtil.getConnection();
			String sqlPage = "select count(*) from yd_tables where no like '3%'";
			PreparedStatement ps1 = conn.prepareStatement(sqlPage);
			ResultSet rs1 = ps1.executeQuery();
			if(rs1.next()) a=rs1.getInt(1);
		} catch (SQLException e) {
	...
	public List<Cui> find_DMZP(Integer startIndex,Integer endIndex){
		...
		try {
			...
			String sql = "SELECT * FROM ("
					+ "SELECT ROWNUM RN,T.* FROM ("
					+ "SELECT * FROM yd_tables where no like '6%' ORDER BY no) T) "
					+ "WHERE RN BETWEEN ? AND ?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setInt(1, startIndex);
			ps.setInt(2, endIndex);
	...
	public int findRow_dmzp(){
		...
		try {
			conn = DBUtil.getConnection();
			String sqlPage = "select count(*) from yd_tables where no like '6%'";
			PreparedStatement ps1 = conn.prepareStatement(sqlPage);
			ResultSet rs1 = ps1.executeQuery();
			if(rs1.next()) a=rs1.getInt(1);
		} catch (SQLException e) {
	...
	public List<Cui> find_XXSC(Integer startIndex,Integer endIndex){
		...
		try {
			...
			String sql = "SELECT * FROM ("
					+ "SELECT ROWNUM RN,T.* FROM ("
					+ "SELECT * FROM yd_tables where no like '8%' ORDER BY no) T) "
					+ "WHERE RN BETWEEN ? AND ?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setInt(1, startIndex);
			ps.setInt(2, endIndex);
	...
	public int findRow_xxsc(){
		...
		try {
			conn = DBUtil.getConnection();
			String sqlPage = "select count(*) from yd_tables where no like '8%'";
			PreparedStatement ps1 = conn.prepareStatement(sqlPage);
			ResultSet rs1 = ps1.executeQuery();
			if(rs1.next()) a=rs1.getInt(1);
		} catch (SQLException e) {
	...
	public List<Cui> find_SHWZ(Integer startIndex,Integer endIndex){
		...
		try {
			...
			String sql = "SELECT * FROM ("
					+ "SELECT ROWNUM RN,T.* FROM ("
					+ "SELECT * FROM yd_tables where no like '2%' ORDER BY no) T) "
					+ "WHERE RN BETWEEN ? AND ?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setInt(1, startIndex);
			ps.setInt(2, endIndex);
	...
	public int findRow_shwz(){
		...
		try {
			conn = DBUtil.getConnection();
			String sqlPage = "select count(*) from yd_tables where no like '2%'";
			PreparedStatement ps1 = conn.prepareStatement(sqlPage);
			ResultSet rs1 = ps1.executeQuery();
			if(rs1.next()) a=rs1.getInt(1);
		} catch (SQLException e) {
	...
	public List<Cui> find_JPNY(Integer startIndex,Integer endIndex){
		...
		try {
			...
			String sql = "SELECT * FROM ("
					+ "SELECT ROWNUM RN,T.* FROM ("
					+ "SELECT * FROM yd_tables where no like '4%' ORDER BY no) T) "
					+ "WHERE RN BETWEEN ? AND ?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setInt(1, startIndex);
			ps.setInt(2, endIndex);
	...
	public int findRow_jpny(){
		...
		try {
			conn = DBUtil.getConnection();
			String sqlPage = "select count(*) from yd_tables where no like '4%'";
			PreparedStatement ps1 = conn.prepareStatement(sqlPage);
			ResultSet rs1 = ps1.executeQuery();
			if(rs1.next()) a=rs1.getInt(1);
		} catch (SQLException e) {
	...
	public List<Cui> find_MJKY(Integer startIndex,Integer endIndex){
		...
		try {
			...
			String sql = "SELECT * FROM ("
					+ "SELECT ROWNUM RN,T.* FROM ("
					+ "SELECT * FROM yd_tables where no like '9%' ORDER BY no) T) "
					+ "WHERE RN BETWEEN ? AND ?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setInt(1, startIndex);
			ps.setInt(2, endIndex);
	...
	public int findRow_mjky(){
		...
		try {
			conn = DBUtil.getConnection();
			String sqlPage = "select count(*) from yd_tables where no like '9%'";
			PreparedStatement ps1 = conn.prepareStatement(sqlPage);
			ResultSet rs1 = ps1.executeQuery();
			if(rs1.next()) a=rs1.getInt(1);
		} catch (SQLException e) {
	...
	public int findRow_ss(String name){
		...
		try {
			conn = DBUtil.getConnection();
			String sqlPage = "select count(*) from ("
					+ "SELECT NO,YNAME,PRICE,SUM(SUMS) "
					+ "S,SUM(MONEY) M FROM YD_SELL WHERE YNAME LIKE ? "
					+ "GROUP BY YNAME,NO,PRICE ORDER BY S DESC)";
